...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-fallback-for-local-dev')
...
DATABASES = {
    'default': {
        ...
        'PORT': os.environ.get('POST_DB_PORT', '5432'),
    }
}
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Post management endpoints with JWT authentication.',
    'VERSION': '1.0.0',
    'SCHEMA_PATH_PREFIX_INSERT': '/posts',
    'SWAGGER_UI_SETTINGS': {
        'deepLinking': True,
        'url': '/posts/api/schema/',
    },
